...
from flask_apps.gender_classification_flask_app.app import app


# Convenience entry point for exposing the local gender API.
if __name__ == "__main__":
    start_ngrok_for_app(app, 5003, "Gender Classification Flask API")
